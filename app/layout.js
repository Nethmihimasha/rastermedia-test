          ...
          <div style={styles.footerColumn}>
            ...
            <ul style={styles.footerList}>
              <li style={styles.contactItem}>
                ...
                <span style={styles.footerLink} className="footer-link">hello@rastermedia.com</span>
              </li>
              <li style={styles.contactItem}>
                <span style={styles.icon} aria-hidden="true">
                ...
                <span style={styles.footerLink} className="footer-link">+1 (555) 123-4567</span>
              </li>
              <li style={styles.contactItem}>
                <span style={styles.icon} aria-hidden="true">
                ...
                <span style={styles.footerLink} className="footer-link">123 Creative Street, NY 10001</span>
              </li>
            </ul>
          </div>
        </div>
